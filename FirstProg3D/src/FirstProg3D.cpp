...
//
//    //Création de ressource pour le Shader dans la graphique 
//    vertexShader = glCreateShader(GL_VERTEX_SHADER);
//    glShaderSource(vertexShader, 1, &vertexShaderSource, NULL);
//    glCompileShader(vertexShader);
//
//    //Verification du succès du lancement du Shader
//    int success;
//    char infoLog[512];
...
//    }
//
//    //Création de ressource pour le fragment Shader 
//    fragmentShader = glCreateShader(GL_FRAGMENT_SHADER);
//    glShaderSource(fragmentShader, 1, &fragmentShaderSource, NULL);
//    glCompileShader(fragmentShader);
//
//    //Création de ressource pour le Shader programm
//    shaderProgram = glCreateProgram(); 
//    glAttachShader(shaderProgram, vertexShader);
//    glAttachShader(shaderProgram, fragmentShader);
//    glLinkProgram(shaderProgram);
//
//    //Vérification de la création du lien avec le Shader programm
